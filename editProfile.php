        ...
        <section class="content_row">
            <div class="user_profile">
                ...
                <nav class="profile_nav">
                    <p class="edit_profile"><i class="fa-regular fa-pen-to-square"></i><a href="profile.php">My Profile</a></p>
            ...
            <div class="user_details">
                <form id="profile_form" action="updateProfile.php" method="POST">
                    ...
                    <input type="text" name="fname" id="fname" placeholder="First name" value="<?php echo htmlspecialchars($fname); ?>" required>
                    
                    <label for="lname">Last Name</label>
                    <input type="text" name="lname" id="lname" placeholder="Last name" value="<?php echo htmlspecialchars($lname); ?>" required>
                    
                    <label for="username">Username</label>
                    <input type="text" name="username" id="username" placeholder="Username" autocomplete="on" value="<?php echo htmlspecialchars($username); ?>" required>
                    
                    <label for="email">Email</label>
                    <input type="email" name="email" id="email" placeholder="Email" autocomplete="on" value="<?php echo htmlspecialchars($email); ?>" required>
                    ...
                    <div class="last_row">
                        ...
                        <button onclick="return confirm('Are you sure you want to cancel edits?')" type="button" class="cancel_btn">Cancel</button>
                    </div>
                </form>
            </div>
        </section>
